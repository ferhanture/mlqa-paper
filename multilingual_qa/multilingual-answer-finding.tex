...
using a discriminative classifier that represents a function of features intended to capture multiple aspects 
between the question and sentence text. We describe details throughout this section.
\ignore{
...
%, all of which is preprocessed with 
...
%Table~\ref{tab:controlled} displays the MAP achieved when training data selection is applied.
